...
const STORAGE_KEYS = {
  TRANSACTIONS: 'budget_buddy_transactions',
  USER_PREFERENCES: 'budget_buddy_preferences',
  CATEGORIES: 'budget_buddy_categories',
  LAST_SYNC: 'budget_buddy_last_sync',
  OFFLINE_CHANGES: 'budget_buddy_offline_changes'
};
